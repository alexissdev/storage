...
public interface ModelReader<R> {
	...
	default <T extends Enum<T>> @Nullable T readEnum(@NotNull String field, @NotNull Class<T> clazz) {
	...
	/**
	 * It reads a list of documents from the given field, and parses each document into a key-value pair using the given
